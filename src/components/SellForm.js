...
class SellForm extends Component {
	...
	makeExchange = async e => {
		...
		let dappQty = String(ethQuantity * exchangeRate);
		let dappQtyWei = await ethers.utils.parseEther(dappQty).toString()
		this.props.sellToken(dappQtyWei)
	}
		...
		return(
			<form className="mb-3" onSubmit={this.makeExchange}>
				...
				<div className="mb-5">
					...
					<span className="float-right text-muted">100 DApp = {exchangeRate / 100} ETH</span>
				</div>
